...
public webapp.Models.Model1 Model { get; set; }
...
WriteLiteral(" src=\"scripts/libs/jquery-3.3.1.min.js\"");
...
WriteLiteral(@">
        ...
        function InvokeCSharpWithFormValues(elm) {
            ...
            if (elms.length > 0)
				qs = qs.substring(1);
			link = ""www.backlkend.com"" + elm.name + ""?"" + qs;
			$(""#result"").html(link);
			location.href = link;
        }
